...
public class Test {
  public static void main(String[] args) {
    ...
    Call c1 = dispatchers.getCall("lala").get(0);
    System.out.println(c1);
    c1.execute();
    Call c2 = dispatchers.getCall("/part1/aaa").get(0);
    System.out.println(c2);
    c2.execute();
    Call c3 = dispatchers.getCall("/part1/bb/12/fdfds").get(0);
    System.out.println(c3);
    c3.execute();
    Call c4 = dispatchers.getCall("/part1/b2/12/fdfds").get(0);
